...
CREATE TABLE `users` (
  ...
  `Hobbies` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
--
-- Dumping routines for database 'baxturedb'
--
...
-- Dump completed on 2024-12-11 20:20:38
